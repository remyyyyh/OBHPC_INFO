...
set output 'dotprod/histogramme/histogram_65536.png'
...
plot 'dotprod/histogramme/histogram_data.txt' using 2:xticlabels(1) title word(method_order, 1), '' using 3 title word(method_order, 2), '' using 4 title word(method_order, 3), '' using 5 title word(method_order, 4), '' using 6 title word(method_order, 5), '' using 7 title word(method_order, 6)
